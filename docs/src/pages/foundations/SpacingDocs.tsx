  ...
  return (
    <article className="prose prose-neutral dark:prose-invert w-full max-w-none">
      ...
      <pre className="rounded-lg border border-border bg-muted p-4">
        <code>{`padding: var(--pario-spacing-4);
margin-bottom: var(--pario-spacing-6);
gap: var(--pario-spacing-2);`}</code>
      </pre>
      <h2 className="mt-10 scroll-m-20 border-b border-border pb-2 text-2xl font-semibold tracking-tight">
        Scale reference
      </h2>
      <div className="overflow-x-auto rounded-lg border border-border">
        <table>
          ...
          <tbody>
            <tr><td><code>--pario-spacing-0</code></td><td>0</td></tr>
            <tr><td><code>--pario-spacing-1</code></td><td>4px</td></tr>
            <tr><td><code>--pario-spacing-2</code></td><td>8px</td></tr>
            <tr><td><code>--pario-spacing-3</code></td><td>12px</td></tr>
            <tr><td><code>--pario-spacing-4</code></td><td>16px</td></tr>
            <tr><td><code>--pario-spacing-5</code></td><td>20px</td></tr>
            <tr><td><code>--pario-spacing-6</code></td><td>24px</td></tr>
            <tr><td><code>--pario-spacing-8</code></td><td>32px</td></tr>
            <tr><td><code>--pario-spacing-10</code></td><td>40px</td></tr>
          </tbody>
        </table>
      </div>
      <h2 className="mt-10 scroll-m-20 border-b border-border pb-2 text-2xl font-semibold tracking-tight">
        ...
        {[
          ...
          <div key={token} className="flex flex-col items-center gap-1">
            <div
              ...
              style={{ height: token === 0 ? 2 : `var(--pario-spacing-${token})` }}
            />
